...
app.post("/register", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const newUser = yield (0, allMethods_1.createUser)({
        name,
        email,
        password,
      });
...
app.put("/api/users/:id/password", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const result = yield (0, allMethods_1.changePassword)(
        Number(userId),
        currentPassword,
        newPassword
      );
    ...
    try {
      ...
      if (updateData.password) {
        return res.status(400).json({
          error:
            "Use el endpoint /api/users/:id/password para cambiar la contraseña",
        });
      }
      const result = yield (0, allMethods_1.updateUser)(
        Number(userId),
        updateData
      );
      res.status(200).json(result);
...
app.get("/users/:userId/pets", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const pets = yield (0, allMethods_1.getPetsByUserId)(
...
app.put("/users/:userId/pets/:petId", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const updated = yield (0, allMethods_1.updatePet)(
...
app.delete("/users/:userId/pets/:petId", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const deleted = yield (0, allMethods_1.deletePet)(
        Number(req.params.petId),
        Number(req.params.userId)
      );
      res.json(deleted);
...
app.get("/pets", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const pets = yield (0, allMethods_1.getAllPets)(
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!reporterName || !reporterPhone || !location) {
        return res.status(400).json({
          error:
            "Faltan datos requeridos: reporterName, reporterPhone, location",
        });
      }
...
app.get("/users/:userId/reports", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      console.log(
        "Reportes para ownerId obtenidos del backend",
        userId,
        ":",
        result.reports
      );
...
app.get("/pets/:petId/reports", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const petId = Number(req.params.petId);
...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self'; connect-src 'self' http://localhost:3000 http://localhost:4000 ws://localhost:4000"
  );
  next();
});
...
app.use((req, res, next) => {
  ...
  if (
    ...
    !req.path.match(/\.(js|css|png|jpg|jpeg|gif|svg|json)$/)
  ) {
