...
const createUser = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newUser = yield models_1.User.create(Object.assign(Object.assign({}, userData), { password: hashedPassword }));
...
const updateUser = (userId, updateData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield user.update(filteredData);
    return {
...
const createPet = (petData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield models_1.User.findByPk(petData.ownerId);
        if (!user) {
            throw new Error('Usuario no encontrado');
        }
        const newPet = yield models_1.Pet.create(petData);
        return {
...
const getPetsByUserId = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getPetById = (petId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const pet = yield models_1.Pet.findOne({
...
const updatePet = (petId, userId, updateData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const pet = yield models_1.Pet.findOne({
...
// Eliminar un reporte
const deletePet = (petId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const pet = yield models_1.Pet.findOne({
            where: { id: petId, ownerId: userId },
        });
...
const getAllPets = (status) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const createReport = (reportData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // 1. Buscar la mascota y verificar que existe
        const pet = yield models_1.Pet.findByPk(reportData.petId, {
            include: [
                {
                    model: models_1.User,
                    as: 'user',
        ...
        const newReport = yield models_1.Report.create({
...
const getPetsByOwnerId = (ownerId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const pets = yield models_1.Pet.findAll({
            where: { ownerId },
            order: [['createdAt', 'DESC']],
...
const getReportsByOwnerId = (ownerId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const reports = yield models_1.Report.findAll({
            where: { ownerId },
            include: [
                {
                    model: models_1.Pet,
...
const getReportsByPetId = (petId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
